...
class CSPS(tk.Frame):
        def __init__(self, parent):
                ...
                self.text2 = self.canvas.create_text(200, 800, tag='text2', fill="white", text="Linear Acceleration \n (Meters/sec^2)")
...
def sendEmail(videoFileName):
        ...
        server.sendmail("coachsafeplaysafe@gmail.com", "coachsafeplaysafe@gmail.com", msg)
        server.quit()
...
def genVideo():
        ...
        videoFileName = "videoofimpact.avi"
